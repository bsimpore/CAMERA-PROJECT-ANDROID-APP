...
public class FacetrackingControl extends AppCompatActivity {

    public void enableVideo(View view) {
        Switch videoSwitch = (Switch) findViewById(R.id.videoSwitch3);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facetracking_control);
    }
}
